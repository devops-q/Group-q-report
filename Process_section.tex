...
%\textit{Alin: Maybe it would be worth adding something about the fact that the database is running inside a VPC without public internet access, therefore only the VM can access it}
